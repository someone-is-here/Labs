...
namespace Lab3 {
    abstract class Sportsman : Person, ICharacterTraitsForSportsman,IComparable<Sportsman> {
        ...
        private void SetHandlers() {
            this.showHandler += () => this.ShowInfo();
            this.showHandler += () => this.ShowCharacterTraits();
            this.showHandler += () => this.ShowStatus();
            this.showHandler += () => this.ShowAchievements();
        }
       ...
       public void GenCharacterTraits() {
        ...
        public delegate void ShowCharacterHandler();
        public event ShowCharacterHandler showHandler;
